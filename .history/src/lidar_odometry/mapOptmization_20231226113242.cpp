...
#pragma omp parallel for num_threads(numberOfCores)
    ...
    ExtractNormals(source, source_normals);
    ExtractNormals(target, target_normals);
    ...
    ComputeKeypoints(
        source, source_normals, harris_params_, icp_threads, source_keypoints);
    ComputeKeypoints(
        target, target_normals, harris_params_, icp_threads, target_keypoints);
