...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<float>( , harris_params_.harris_threshold_, );
        nh.param<float>( , harris_params_.harris_suppression_, );
        nh.param<float>( , harris_params_.harris_radius_, );
        nh.param<float>( , harris_params_.harris_refine_, );
        nh.param<float>( , harris_params_.harris_response_, );
