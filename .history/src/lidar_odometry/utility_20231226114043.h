...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<float>(PROJECT_NAME + "harris_suppression", harris_params_.harris_suppression_, );
        nh.param<float>(PROJECT_NAME + "harris_radius", harris_params_.harris_radius_, );
        nh.param<float>(PROJECT_NAME + "harris_refine", harris_params_.harris_refine_, );
        nh.param<float>(PROJECT_NAME + "harris_response", harris_params_.harris_response_, );
