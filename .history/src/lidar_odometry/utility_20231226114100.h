...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<float>(PROJECT_NAME + "harris_threshold", harris_params_.harris_threshold_, 0.000000005);
        nh.param<float>(PROJECT_NAME + "harris_suppression", harris_params_.harris_suppression_, true);
        nh.param<float>(PROJECT_NAME + "harris_radius", harris_params_.harris_radius_, 0.1);
        nh.param<float>(PROJECT_NAME + "harris_refine", harris_params_.harris_refine_, false);
        nh.param<float>(PROJECT_NAME + "harris_response", harris_params_.harris_response_, 1);
